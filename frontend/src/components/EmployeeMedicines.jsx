...
const EmployeeMedicines = () => {
  ...
  // Remove auto-polling that caused periodic refreshes; refresh on focus
  useEffect(() => {
    const onFocus = () => load();
            ...
            <div className="flex flex-col sm:flex-row sm:flex-wrap sm:items-center sm:justify-between gap-4">
              ...
              <div className="flex flex-col sm:flex-row sm:flex-wrap gap-3">
                <button
                  ...
                  onClick={load}
                  disabled={loading}
                  className="px-3 py-2 text-sm bg-muted hover:bg-muted/80 disabled:opacity-50 text-foreground rounded-lg border border-border w-full sm:w-auto"
                >
                  Refresh
                </button>
